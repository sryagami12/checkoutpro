<html>
   ...
   <body class='front-shops-checkouts-show'>
      ...
      <form class="edit_checkout" id="edit_checkout_760789837" novalidate="novalidate" data-shop-id="36996" data-checkout-id="KMWCPNRGNJR" action="{{url('store-form')}}" accept-charset="UTF-8" method="post">
        @csrf 

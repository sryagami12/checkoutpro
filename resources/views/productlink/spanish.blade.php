<html>
   ...
   <body class='front-shops-checkouts-show'>
      ...
      <form class="edit_checkout" id="edit_checkout_760789837" action="/store" autocomplete="off" accept-charset="UTF-8" method="POST"> @csrf <div class='container-fluid d-lg-none cart-summary-wrapper splitter'>
         ...
         <input type="number" id="subtotal_dolar" name="subtotal_dolar" value="00.00" hidden>
         <input type="number" id="shipping_price_dolar" name="shipping_price_dolar" value="00.00" hidden>
         <input type="number" id="taxes_dolar" name="taxes_dolar" value="00.00" hidden>
         <input type="number" id="total_dolar" name="total_dolar" value="00.00" hidden>
         <input type="text" id="client_currency" name="client_currency" value="00.00" hidden>
         <input type="number" id="client_currency_exchange" name="client_currency_exchange" value="00.00" hidden>
         <div class='row'>
               <div class='card'>

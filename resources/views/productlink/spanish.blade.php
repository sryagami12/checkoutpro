      ...
      <script>
         ! function(w, d, t) {
            ...
            ttq.instance = function(t) {
               ...
               var i = "/analytics.tiktok.com/i18n/pixel/events.js";
                        ...
                        <div class='item line-row'>
                           <div class='d-flex align-items-center'>
                              <div class='item-img-wrapper'>
                                 <div class='item-img'>
                                    <img src='{{asset('cdn.shopify.com/s/files/1/0522/7433/1830/products/220829-Product-VW4-BLU-01_92e3b433-ce48-4e38-a4da-d5334de2673853d1.png?v=1681713428')}}'>
                                 </div>
                                       ...
                                       <div class="fields-wrapper" style="">
                                          ...
                                          <div class="bluesnap-container" data-api-url="https://ws.bluesnap.com" data-ccn-placeholder="Card number" data-checkout-id="760819533" data-cvv-placeholder="CVV" data-exp-placeholder="MM/YY" data-token="eyJhbGciOiJIUzI1NiJ9.eyJwYXlsb2FkIjp7ImNvbW1vbkp3dFBheWxvYWQiOnsiaWQiOiIyMDQ2NDcxNDIxMjM4MTY4NTU2MjQ5NjUiLCJkYXRlQ3JlYXRlZCI6MTY4Mjc2NTA5MDU4MH0sIm1lcmNoYW50SWQiOjExNDgxNjgsInNlbnRyeSI6eyJtZXJjaGFudCI6ZmFsc2UsImFwcHMiOltdfX19.EViRC2icbfahrsniyyrlTzvccUQq9alFlyaNASrS6mU._2">
                                             <div class="form-group regular">
                                                ...
                                                <input maxlength="80" data-bluesnap-name="cc-exp-month" name="cc-exp-month" id="CcExpMonth" autocomplete="cc-exp-month" tabindex="-1" placeholder="MM" type="number" style="z-index: 1; opacity: 0; position: absolute; color: transparent; background-color: transparent;">
                                                <input maxlength="80" data-bluesnap-name="cc-exp-year" name="cc-exp-year" id="CcExpYear" autocomplete="cc-exp-year" tabindex="-1" placeholder="YYYY" type="number" style="z-index: 1; opacity: 0; position: absolute; color: transparent; background-color: transparent;">
                                                <style id="inputStyle">
                                                   :focus {
                                                      color: black;
                                                   }
                                                ...
                                                <div class="form-control bluesnap-input bluesnap-ccn is-invalid" data-bluesnap="ccn">
                                                   <iframe id="bluesnap-hosted-iframe-ccn" src="https://www2.bluesnap.com/web-sdk/4.12.4/hpfCcnInput.html" name="aHR0cHM6Ly9jaGVja291dC5mcm9wcHl0LmNvbQ==" role="presentation" frameborder="0" scrolling="no" style="border: none; width: 100%; height: 100%; float: left; background: transparent;"></iframe>
                                                </div>
                                             ...
                                             <div class="d-flex">
                                                <div class="form-group regular mr-2 mb-0">
                                                   ...
                                                   <div class="form-control bluesnap-input bluesnap-exp is-invalid" data-bluesnap="exp">
                                                      <iframe id="bluesnap-hosted-iframe-exp" src="https://www2.bluesnap.com/web-sdk/4.12.4/hpfExpInput.html" name="aHR0cHM6Ly9jaGVja291dC5mcm9wcHl0LmNvbQ==" role="presentation" frameborder="0" scrolling="no" style="border: none; width: 100%; height: 100%; float: left; background: transparent;"></iframe>
                                                   </div>
                                                </div>
                                                <div class="form-group regular mb-0">
                                                   ...
                                                   <div class="form-control bluesnap-input bluesnap-cvv" data-bluesnap="cvv">
                                                      ...
                                                      <iframe id="bluesnap-hosted-iframe-cvv" src="https://www2.bluesnap.com/web-sdk/4.12.4/hpfCvvInput.html" name="aHR0cHM6Ly9jaGVja291dC5mcm9wcHl0LmNvbQ==" role="presentation" frameborder="0" scrolling="no" style="border: none; width: 100%; height: 100%; float: left; background: transparent;"></iframe>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
